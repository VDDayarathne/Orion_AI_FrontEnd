    ...
    <Container className="mt-5">
      ...
      <Row className="mt-4">
        ...
        <Col md={6}>
          <h5>Output</h5>
          <Card>
          <Card.Body style={{color:"white"}}>{output || "No response yet"}</Card.Body>
          </Card>
        </Col>
      </Row>
      ...
      <Row style={{ margin: "50px" }}>
          ...
          <Col md={2}>
            <Button variant="light" style={{ margin: "20px", alignContent: "flex-end", justifyContent: "left" }} onClick={() => window.location.href='/Task2'}>
