    ...
    <Container className="mt-5">
      <Row>
        ...
        <h2 className="task-title">Task 4</h2>
          <h4 className="text-secondary">Illustrate a Complex Object with Intricate Details</h4>
        </Col>
      </Row>
      <Row className="mt-4">
        <Col md={8}>
          <Card className='card'>
            <Card.Body className='card-body'>
              ...
              In the Vault of Wonders, a mysterious artifact has been discovered, said to hold secrets of the kingdom’s ancient history. The Artisan Council tasks you with illustrating this complex object, capturing its intricate details and enigmatic aura.</Card.Text>
              <Card.Title style={{color:"white"}}>Objective</Card.Title>
              <Card.Text style={{color:"white"}}>
              Write a prompt to create a detailed illustration of an artifact, incorporating ornate engravings, layered textures, and a sense of historical significance. </Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4}>
      ...
      {taskProgress && (
          <Row style={{ margin: "50px" }}>
            ...
            <Col md={2}>
              <Button variant="light" style={{ margin: "20px" }} onClick={() => window.location.href='/TaskA35'}>
                Next Task
              </Button>
            </Col>
          </Row>
