  ...
  const [prompt, setPrompt] = useState('');
    ...
    <Container className="mt-5">
      <Row>
        ...
        <h4 className="text-secondary">Design a Character with Expressive Emotions.</h4>
        </Col>
      </Row>
      <Row className="mt-4">
        <Col md={8}>
          <Card className='card'>
            <Card.Body className='card-body'>
              ...
              In the Theatre of Expressions, the Artisan Council is developing a new play to inspire hope in the face of rising challenges. They request your help in designing a character whose expressive emotions can convey complex narratives and resonate deeply with the audience. </Card.Text>
              <Card.Title style={{color:"white"}}>Objective</Card.Title>
              <Card.Text style={{color:"white"}}>
              Create a prompt to design a character with a focus on expressive facial features and body language. The character should convey a mix of hope and determination, capturing their resilience and resolve.</Card.Text>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4}>
      ...
      {taskProgress && (
          <Row style={{ margin: "50px" }}>
            ...
            <Col md={2}>
              <Button variant="light" style={{ margin: "20px" }} onClick={() => window.location.href='/TaskA33'}>
                Next Task
              </Button>
            </Col>
          </Row>
